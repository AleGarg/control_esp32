...
def setup_connection():
    global ssid, password, server_ip
    ssid = input("Ingrese el SSID (nombre) de la red WiFi: ")
    password = input("Ingrese la contraseña de la red WiFi: ") # IP de tu computadora (VER EN IPCONFIG)
    server_ip = input("Ingrese la IP del servidor (ej. 192.168.3.11): ")
...
def callback(data, addr, ctrl):
    ...
    if data > 0:
        ...
        enviar_datos(valor_recibido)  # Llama a la función para enviar datos
